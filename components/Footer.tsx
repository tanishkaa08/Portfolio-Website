    ...
    <footer className="bg-secondary py-8">
      <div className="container mx-auto px-6 text-center bg-white/30 text-pink-800">
        <div className="flex justify-center space-x-6 mb-4">
          ...
          <motion.a whileHover={{ y: -3, scale: 1.1 }} href="https://discordapp.com/users/tanishkaa_08" target="_blank" rel="noopener noreferrer" className="hover:text-highlight transition-colors duration-300"><FaDiscord size={30} /></motion.a>
        </div>
